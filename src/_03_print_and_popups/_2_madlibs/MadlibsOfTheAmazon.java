...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog("Enter the name of a liquid");
		// Get the player to enter a body part
		String body = JOptionPane.showInputDialog("Enter the name of a body part");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter a verb");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Enter the name of a place");
